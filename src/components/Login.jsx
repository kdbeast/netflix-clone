      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL: "https://avatars.githubusercontent.com/u/99739348?v=4",
          })
            .then(() => {
  ...
  return (
    <div>
      ...
      <form
        ...
        className=" w-3/12 mx-auto absolute p-12 bg-black/70 my-36 right-0 left-0 text-white rounded-lg"
      >
